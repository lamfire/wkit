	...
	<div class="main">
	    <div class="wapper">
	        ...
	        <div class="view">
	           ...
	           <form id="submitform" action="${pageContext.request.contextPath}/json.do" method="post" target="_blank">
	                <div>
	            ...
	            <div class="h20"></div>
	            <div>JSP面页代码请见:WebRoot/actions/json.jsp</div>
	        	<div>Action处理代码请见:com.lamfire.wkit.demo.action.JsonAction</div>
	        </div>
	    </div>
	</div>
</div>
